                                ...
                                <div class="card-body">
                                    <div class="col d-flex align-items-center justify-content-center">
                                        <div class="table-responsive col-md-8">
                                            ...
                                            <center><table style="border:3px solid black" class="table table-active text-center table-borderless">
                                                <thead>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%">
                                                            <h1 style="color:red"style="width: 20%" align="center">SCORE</h1>
                                                        </td>
                                                        <td align="center">
