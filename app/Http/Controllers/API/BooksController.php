...
class BooksController extends Controller
{
    ...
    {
        return view ('pages.book.tambahBook');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.book.editBook',$data);
    }
    ...
    public function book()
    {
        ...
        return view('pages.book.dataBook',$data); 
    }
